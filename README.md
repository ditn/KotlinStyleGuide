...
An alternative to this issue is to import the snake_case properties and then use `as` to rename them:

```kotlin
import kotlinx.android.synthetic.main.activity_main.button_next as buttonNext
```
This is probably overkill, but a neat solution if you want to be a stickler for code style.
